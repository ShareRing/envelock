...
-keep class network.sharering.envelock.reactnative.** { *; }
-keep class com.sun.jna.** { *; }
-keep class * implements com.sun.jna.** { *; }

# JNA ships desktop AWT integration that cannot exist on Android. The references are never
# reached at runtime, but R8 fails the build over them unless told they are expected.
-dontwarn java.awt.**
